...
hist(df$TotalHeight, main = paste("gráfico de densidad en la variable ``TotalHeight``"), ylab = "Frecuencia", xlab = "TotalHeight")
...
ll_mean_plot <- function(mu, n) {
  ...
  return(-sum(dnorm(x, mean=mu, sd=15, log=TRUE)))
}
n = c(100,300,716)
