...
mu.link1 <- function(weight) post$b0 + post$b1*weight
...
# plot raw data
plot( height ~ weight , data=d1.hw , col=col.alpha(rangi2,0.5) )
# draw MAP line
...
mu.link2 <- function(weight) post$b0 + post$b1*weight
...
# plot raw data
plot( height ~ weight , data=d2.hw , col=col.alpha(rangi2,0.5) )
# draw MAP line
